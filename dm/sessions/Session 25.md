...
- Party bartered off their rations to a swarm of crabs
	- Managed to befriend the crabstrocity...
- Met [[Skipper Art Caraway]] - talked a bit, learned some more about the siege
- Interacted with Umi, the silver pseudodragon from [[Nymphsong]]
...
| Obstacle     | PC Detection | Navigation/Evasion | Penalty if Failure      |
| ------------ | ------------ | ------------------ | ----------------------- |
| Mines        | 15           | 16                 | 4d6 force; 4d6 necrotic |
| Low combat   | 14           | 15                 | combat                  |
| mid-combat   | 12           | 17                 | combat                  |
| large-combat | 10           | 20                 | combat                  |

### Siege Pirate Captains of [[The Reinvention]]
...
- Sloops
	...
	- Combat stats (per ship)
		- https://krfurlong.github.io/bestiary/creature/shadow-fey-duelist (snagtooth, prisima)
		- https://krfurlong.github.io/bestiary/creature/master-thief (gorpnik)
		- 1d4-1 https://krfurlong.github.io/bestiary/creature/brine-zombie; +1 https://krfurlong.github.io/bestiary/creature/sharkjaw-skeleton
- Brigantines
	-  Captain/Living person names:
...
- Frigates
	...
	- Combat stats:
		...
		- 1d3 Brine Zombies, 1d3 shadows (https://krfurlong.github.io/bestiary/creature/shadow), 1d4 zombies (e.g., swarms - for numbers purposes)
- Bosses
	- Overseer of the siege and of [[The Reinvention]]: [[Jasad Peatmire]] - a...half-elven...man? with original ties to [[The Sleepwalkers]] - son of the cleric at the time of exile and convinced that this is the way the world should return
		- Stats for Jasad: https://krfurlong.github.io/bestiary/creature/river-king (cr16)
		- Stats for [[Osiris Siltguard]]: https://krfurlong.github.io/bestiary/creature/soul-monger (cr11)
